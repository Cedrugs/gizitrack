...
import truckLightIcon from "@/Assets/icons/truck-light.png"
import moneyBillIcon from "@/Assets/icons/money-bill.png"
import robotIcon from "@/Assets/icons/robot.png"

import testimoniImage1 from "@/Assets/images/testimoni-1.png" 
import testimoniImage2 from "@/Assets/images/testimoni-2.png"
import testimoniImage3 from "@/Assets/images/testimoni-3.png"
import testimoniImage4 from "@/Assets/images/testimoni-4.png"
...
export default function Landing() {
    return (
        <>
            <Head title="Welcome"/>
            <Navbar />
            <header className="flex flex-col relative bg-cover bg-center justify-center items-center text-center h-screen gap-12 p-8" style={{ backgroundImage: `url(${heroImage})` }}>
